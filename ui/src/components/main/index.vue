<template>
    <el-container>
        ...
        <el-aside width="200px">
            <el-row>
                <el-col :span="24">
                    <el-image style="width: 120px;height: 60px;display: block;margin: 40px auto;" fit="fill" :src="require('@/assets/image/main_logo.png')"></el-image>
        ...
        <el-container>
            <el-header>
                ...
                <el-button color="#626aef" @click="doLogout" palain>
                    登出
                </el-button>
            </el-header>
            <!--进行路由跳转-->
